load 'pockets_create_new_view.rb'
load 'pockets_delete_view.rb'
load 'pockets_show_all_view.rb'
load 'pockets_deposit_money_view.rb'
load 'pockets_withdraw_money_view.rb'
load 'pockets_send_money_view.rb'
