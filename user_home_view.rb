load 'main_account_available_money_view.rb'
load 'main_account_total_money_view.rb'
load 'main_account_deposit_money_view.rb'
load 'main_account_withdraw_money_view.rb'
load 'main_account_send_money_view.rb'
load 'transactions_show_view.rb'
load 'mattress_view.rb'
load 'pockets_view.rb'
load 'goals_view.rb'
